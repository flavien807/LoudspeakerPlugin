package com.flavien.positiv.com;
...
@CapacitorPlugin(name = "loudspeakerPluginControl")
public class loudspeakerPluginControlPlugin extends Plugin {

    private loudspeakerPluginControl implementation = new loudspeakerPluginControl();
